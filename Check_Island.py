...
def find_Instance(in_line):
	out= in_line.split(':') 		#i.e {samplestorageisland}01-oss5:JBOD_5_6_SLOT_42 will be splitted at the ':'
	split = out[1].strip() 			#Remove all unwanted spaces
	prefixes = ['JBOD','','raidz','mirror']   #Put all your prefixs here
...
cmd = 'psh {samplestorageisland}01-02 "zpool status" > out.txt'	 					# find all errors from zpool
